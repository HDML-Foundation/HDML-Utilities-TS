...
export class CommonParametersStruct {
  ...
  static getRootAsCommonParametersStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: CommonParametersStruct,
  ): CommonParametersStruct {
    return (obj || new CommonParametersStruct()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsCommonParametersStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: CommonParametersStruct,
  ): CommonParametersStruct {
  ...
  static endCommonParametersStruct(
    builder: flatbuffers.Builder,
  ): flatbuffers.Offset {
  ...
  static createCommonParametersStruct(
    builder: flatbuffers.Builder,
    nullable: boolean,
  ): flatbuffers.Offset {
