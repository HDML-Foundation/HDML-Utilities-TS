...
export class ElasticsearchParametersStruct {
  ...
  static getRootAsElasticsearchParametersStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: ElasticsearchParametersStruct,
  ): ElasticsearchParametersStruct {
    return (obj || new ElasticsearchParametersStruct()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsElasticsearchParametersStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: ElasticsearchParametersStruct,
  ): ElasticsearchParametersStruct {
  ...
  static startElasticsearchParametersStruct(
  ...
  static addRegion(
    builder: flatbuffers.Builder,
    regionOffset: flatbuffers.Offset,
  ) {
  ...
  static addAccessKey(
    builder: flatbuffers.Builder,
    accessKeyOffset: flatbuffers.Offset,
  ) {
  ...
  static addSecretKey(
    builder: flatbuffers.Builder,
    secretKeyOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(7, secretKeyOffset, 0);
  }

  static endElasticsearchParametersStruct(
    builder: flatbuffers.Builder,
  ): flatbuffers.Offset {
  ...
  static createElasticsearchParametersStruct(
    builder: flatbuffers.Builder,
    hostOffset: flatbuffers.Offset,
    port: number,
    userOffset: flatbuffers.Offset,
    ...
    ElasticsearchParametersStruct.startElasticsearchParametersStruct(
      builder,
    );
    ...
    ElasticsearchParametersStruct.addPassword(
      builder,
      passwordOffset,
    );
    ElasticsearchParametersStruct.addSsl(builder, ssl);
    ElasticsearchParametersStruct.addRegion(builder, regionOffset);
    ElasticsearchParametersStruct.addAccessKey(
      builder,
      accessKeyOffset,
    );
    ElasticsearchParametersStruct.addSecretKey(
      builder,
      secretKeyOffset,
    );
    return ElasticsearchParametersStruct.endElasticsearchParametersStruct(
      builder,
    );
  }
}
