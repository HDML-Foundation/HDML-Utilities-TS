...
export class HDOMStruct {
  ...
  static getRootAsHDOMStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: HDOMStruct,
  ): HDOMStruct {
    return (obj || new HDOMStruct()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsHDOMStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: HDOMStruct,
  ): HDOMStruct {
  ...
  ): ConnectionStruct | null {
    const offset = this.bb!.__offset(this.bb_pos, 6);
    return offset
      ? (obj || new ConnectionStruct()).__init(
          this.bb!.__indirect(
            this.bb!.__vector(this.bb_pos + offset) + index * 4,
          ),
          this.bb!,
  ...
  static addIncludes(
    ...
    includesOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(0, includesOffset, 0);
  }

  static createIncludesVector(
    builder: flatbuffers.Builder,
  ...
  static addConnections(
    builder: flatbuffers.Builder,
    connectionsOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(1, connectionsOffset, 0);
  }

  static createConnectionsVector(
    builder: flatbuffers.Builder,
    data: flatbuffers.Offset[],
  ): flatbuffers.Offset {
    builder.startVector(4, data.length, 4);
  ...
  static addModels(
    builder: flatbuffers.Builder,
    modelsOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(2, modelsOffset, 0);
  }

  static createModelsVector(
    builder: flatbuffers.Builder,
    data: flatbuffers.Offset[],
  ): flatbuffers.Offset {
    builder.startVector(4, data.length, 4);
