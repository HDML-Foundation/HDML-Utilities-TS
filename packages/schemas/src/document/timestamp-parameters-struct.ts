...
export class TimestampParametersStruct {
  ...
  static getRootAsTimestampParametersStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: TimestampParametersStruct,
  ): TimestampParametersStruct {
    return (obj || new TimestampParametersStruct()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsTimestampParametersStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: TimestampParametersStruct,
  ): TimestampParametersStruct {
  ...
  static startTimestampParametersStruct(
  ...
  static endTimestampParametersStruct(
    builder: flatbuffers.Builder,
  ): flatbuffers.Offset {
  ...
  static createTimestampParametersStruct(
    builder: flatbuffers.Builder,
    nullable: boolean,
    unit: TimeUnitEnum,
    timezone: TimeZoneEnum,
    ...
    return TimestampParametersStruct.endTimestampParametersStruct(
      builder,
    );
  }
}
