...
export class FrameStruct {
  ...
  bb_pos = 0;
  __init(i: number, bb: flatbuffers.ByteBuffer): FrameStruct {
    this.bb_pos = i;
    this.bb = bb;
    return this;
  }

  static getRootAsFrameStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: FrameStruct,
  ): FrameStruct {
    return (obj || new FrameStruct()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsFrameStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: FrameStruct,
  ): FrameStruct {
  ...
  filterBy(obj?: FilterClauseStruct): FilterClauseStruct | null {
    const offset = this.bb!.__offset(this.bb_pos, 16);
    return offset
      ? (obj || new FilterClauseStruct()).__init(
  ...
  groupBy(index: number, obj?: FieldStruct): FieldStruct | null {
  ...
  splitBy(index: number, obj?: FieldStruct): FieldStruct | null {
  ...
  sortBy(index: number, obj?: FieldStruct): FieldStruct | null {
  ...
  static startFrameStruct(builder: flatbuffers.Builder) {
  ...
  static addFilterBy(
    builder: flatbuffers.Builder,
    filterByOffset: flatbuffers.Offset,
  ) {
  ...
  static addGroupBy(
    builder: flatbuffers.Builder,
    groupByOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(7, groupByOffset, 0);
  }

  static createGroupByVector(
    builder: flatbuffers.Builder,
    data: flatbuffers.Offset[],
  ): flatbuffers.Offset {
    builder.startVector(4, data.length, 4);
  ...
  static addSplitBy(
    builder: flatbuffers.Builder,
    splitByOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(8, splitByOffset, 0);
  }

  static createSplitByVector(
    builder: flatbuffers.Builder,
    data: flatbuffers.Offset[],
  ): flatbuffers.Offset {
    builder.startVector(4, data.length, 4);
  ...
  static addSortBy(
    builder: flatbuffers.Builder,
    sortByOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(9, sortByOffset, 0);
  }

  static createSortByVector(
    builder: flatbuffers.Builder,
    data: flatbuffers.Offset[],
  ): flatbuffers.Offset {
    builder.startVector(4, data.length, 4);
