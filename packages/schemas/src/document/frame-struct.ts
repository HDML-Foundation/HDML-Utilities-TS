...
static getRootAsFrameStruct(bb:flatbuffers.ByteBuffer, obj?:FrameStruct):FrameStruct {
  return (obj || new FrameStruct()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsFrameStruct(bb:flatbuffers.ByteBuffer, obj?:FrameStruct):FrameStruct {
...
static endFrameStruct(builder:flatbuffers.Builder):flatbuffers.Offset {
