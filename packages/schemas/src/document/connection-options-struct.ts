...
import {
  ConnectionParametersStruct,
  unionToConnectionParametersStruct,
  unionListToConnectionParametersStruct,
} from "../document/connection-parameters-struct.js";
...
export class ConnectionOptionsStruct {
  ...
  static getRootAsConnectionOptionsStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: ConnectionOptionsStruct,
  ): ConnectionOptionsStruct {
    return (obj || new ConnectionOptionsStruct()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsConnectionOptionsStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: ConnectionOptionsStruct,
  ): ConnectionOptionsStruct {
  ...
  parametersType(): ConnectionParametersStruct {
    ...
    return offset
      ...
      : ConnectionParametersStruct.NONE;
  }
  ...
  static endConnectionOptionsStruct(
    builder: flatbuffers.Builder,
  ): flatbuffers.Offset {
  ...
  static createConnectionOptionsStruct(
    builder: flatbuffers.Builder,
    connector: ConnectorTypesEnum,
    parametersType: ConnectionParametersStruct,
    parametersOffset: flatbuffers.Offset,
    ...
    ConnectionOptionsStruct.addParametersType(
      builder,
      parametersType,
    );
