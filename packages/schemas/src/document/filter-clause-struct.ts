...
export class FilterClauseStruct {
  ...
  static getRootAsFilterClauseStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: FilterClauseStruct,
  ): FilterClauseStruct {
    return (obj || new FilterClauseStruct()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsFilterClauseStruct(
    bb: flatbuffers.ByteBuffer,
    obj?: FilterClauseStruct,
  ): FilterClauseStruct {
  ...
  static addFilters(
    builder: flatbuffers.Builder,
    filtersOffset: flatbuffers.Offset,
  ) {
    builder.addFieldOffset(1, filtersOffset, 0);
  }

  static createFiltersVector(
    builder: flatbuffers.Builder,
  ...
  static createFilterClauseStruct(
    builder: flatbuffers.Builder,
    type: FilterOperatorEnum,
    filtersOffset: flatbuffers.Offset,
    childrenOffset: flatbuffers.Offset,
