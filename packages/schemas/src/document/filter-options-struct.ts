...
export function unionToFilterOptionsStruct(
  ...
  switch (FilterOptionsStruct[type]) {
    case "NONE":
      return null;
    case "ExpressionParametersStruct":
      return accessor(
        new ExpressionParametersStruct(),
      )! as ExpressionParametersStruct;
    case "KeysParametersStruct":
      return accessor(
        new KeysParametersStruct(),
      )! as KeysParametersStruct;
    case "NamedParametersStruct":
      return accessor(
        new NamedParametersStruct(),
      )! as NamedParametersStruct;
    default:
      return null;
  }
}
